...
# %%
df.info() #La seule colonne entièrement vide est la colonne Size
...
print(df.loc[88]) #erreur car elle a été suprimé
...
# %%
print(df.dtypes)
#la colonne des masses est en chaine de caractères alors que cela devrait être des nombres
...
# %%
df['Mass (lb)'].unique()
#les valeurs contiennent des caractères sépciaux du types < ou > ce qui empêche leur type d'être de valeurs numériques.
